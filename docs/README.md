...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-16 22:22:31 UTC<br>状态：成功</p>
</section>
...
<p>2026-09-16 日报精选 2 篇，精读微引力透镜发现的双木星级 M 矮星行星系统。最值得看的是 KMT-2026-BLG-0083L 这套两颗木星级行星绕 M 矮星运行的罕见构型，以及速读中无梯度神经 Hamilton-Jacobi 可达性用于可扩展安全控制。普通读者可优先读精读论文，顺带了解后者在安全关键控制中的应用思路。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="KMT-2026-BLG-0083L: A Two-Jovian-Planet System Orbiting an M Dwarf Discovered by Microlensing">KMT-2026-BLG-0083L: A Two-Jovian-Planet System Orbiting an M Dwarf Discovered by Microlensing</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">exoplanets <strong>1</strong></span></div>
</section>
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Gradient-Free Neural Hamilton-Jacobi Reachability for Scalable Safety-Critical Control">Gradient-Free Neural Hamilton-Jacobi Reachability for Scalable Safety-Critical Control</span></li></ul>
  </div>
